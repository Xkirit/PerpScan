...
// Fix the symbol cell with proper new indicator
const oldSymbolSection = `                <td className="px-1 sm:px-6 py-2 sm:py-4 whitespace-nowrap">
...
const newSymbolSection = `                <td className="px-1 sm:px-6 py-2 sm:py-4 whitespace-nowrap">
...
content = content.replace(oldSymbolSection, newSymbolSection);

fs.writeFileSync('src/components/DataTable.tsx', content);
console.log('Fixed DataTable with new indicator');
